...
<div id="app" v-cloak class="container mt-4">
    ...
    <table class="table align-middle">
        ...
        <tr>
            ...
            <td><i class="bi bi-pencil" v-if="!edit.username" @click="show_edit('username')"></i></td>
            <td></td>
        </tr>
        ...
        <tr>
            ...
            <td><i class="bi bi-pencil" v-if="!edit.email" @click="show_edit('email')"></i></td>
            <td></td>
        </tr>
        ...
        <tr>
            ...
            <td><i class="bi bi-box-arrow-up-right" @click="copy_text_to_clipboard(user.apikey_write,'<?php echo addslashes(tr("Write API Key copied to clipboard")); ?>')"></i></td>
            <td>
        ...
        <tr>
            ...
            <td><i class="bi bi-box-arrow-up-right" @click="copy_text_to_clipboard(user.apikey_read,'<?php echo addslashes(tr("Read API Key copied to clipboard")); ?>')"></i></td>
            <td>
        ...
        <tr>
            ...
            <td><i class="bi bi-pencil" v-if="!edit.password" @click="show_edit('password')"></i></td>
            <td></td>
        </tr>
    ...
    <table class="table align-middle">
        <tr>
            ...
            <td><i class="bi bi-pencil" v-if="!edit.gravatar" @click="show_edit('gravatar')"></i></td>
        </tr>
        ...
        <tr>
            ...
            <td><i class="bi bi-pencil" v-if="!edit.name" @click="show_edit('name')"></i></td>
        </tr>
        ...
        <tr>
            ...
            <td><i class="bi bi-pencil" v-if="!edit.location" @click="show_edit('location')"></i></td>
        </tr>
        ...
        <tr>
            ...
            <td><i class="bi bi-pencil" v-if="!edit.timezone" @click="show_edit('timezone')"></i></td>
        </tr>
        ...
        <tr>
            ...
            <td><i class="bi bi-pencil" v-if="!edit.language" @click="show_edit('language')"></i></td>
        </tr>
        ...
        <tr>
            ...
            <td><i class="bi bi-pencil" v-if="!edit.startingpage" @click="show_edit('startingpage')"></i></td>
        </tr>
